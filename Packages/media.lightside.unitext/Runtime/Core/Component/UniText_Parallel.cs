...
namespace LightSide
{
    ...
    public partial class UniText
    {
        ...
        public int TestRenderedGlyphCount => meshGenerator != null ? meshGenerator.RenderedGlyphCount : 0;
        ...
        protected override void CopyMeshesForTests()
        {
            ...
            {
                var copy = new Mesh();
                var indexFormat = rd.vertexCount > MaxCanvasSubMeshVertices
                    ? IndexFormat.UInt32
                    : IndexFormat.UInt16;
                BuildMeshInto(copy, in rd, indexFormat);
